              ...
              {currentTodo ? (
                <>
                  <button
                    ...
                    className="bg-indigo-500 text-white py-3 px-7 rounded-md"
                  >
                    {" "}
                    Save
                  </button>
                  ...
                  <button
                    className="bg-slate-800 rounded-md text-white py-3 px-7"
      ...
      <div className=" flex items-center justify-center flex-col">
        {todoList.length === 0 ? (
          <div className="mb-6">
            ...
            <p className="text-center text-Gray">Fill out your plan today</p>
          </div>
        ) : (
          <div className="container mx-auto mt-6">
            <div className="flex justify-center mb-6">
              <select
                ...
                className="p-1 outline-1 text-sm"
              >
            ...
            <div>
              {sortToDoList.map((todo) => (
                <div
                  ...
                  mb-6 bg-slate-800 mx-auto w-full md:w-[75%] rounded-md p-4"
                >
                  <div
                    className={`${
                      todo.completed
        ...
        <button
          className="bg-indigo-500 text-center text-white py-3 px-10 rounded-md"
          onClick={() => {
            setShowModal(true);
          }}
        >
